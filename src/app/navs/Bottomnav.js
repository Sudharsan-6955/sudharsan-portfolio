  ...
  return (
    <nav className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white/10 backdrop-blur-md rounded-full transition-transform duration-300 z-50 shadow-lg ${!isVisible ? 'translate-y-0' : 'translate-y-32'}`}>
      <div className="px-8 py-4 flex items-center justify-center gap-12">
        {/* Home Icon */}
        <a href="#home" onClick={(e) => handleScrollTo(e, 'home')} className="relative group cursor-pointer" aria-label="Home">
        ...
        <a href="#about" onClick={(e) => handleScrollTo(e, 'about')} className="relative group cursor-pointer" aria-label="About">
          <svg className="w-6 h-6 text-white hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#work" onClick={(e) => handleScrollTo(e, 'work')} className="relative group cursor-pointer" aria-label="Work">
          <svg className="w-6 h-6 text-white hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#contact" onClick={(e) => handleScrollTo(e, 'contact')} className="relative group cursor-pointer" aria-label="Contact">
          <svg className="w-6 h-6 text-white hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
